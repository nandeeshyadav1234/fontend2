...
const Brokers = () => {
  ...
  useEffect(() => {
    const fetchBrokers = async () => {
      try {
        ...
        const filteredBrokers = response.data.filter((broker) => broker.role_id == 2); 
  ...
  return (
    <Box sx={{ padding: 2 }}>
      <Typography variant="h4" gutterBottom>Brokers Management</Typography>
      <Button variant="contained" color="primary" onClick={() => handleOpen()}>Add New Broker</Button>
